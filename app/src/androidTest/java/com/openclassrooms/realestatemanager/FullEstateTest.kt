...
open class FullEstateTest {
    ...
    private val ESTATE_PRICE = 209000
    ...
    @Before
    fun initDB(){
        this.database = Room.inMemoryDatabaseBuilder(InstrumentationRegistry.getInstrumentation().getTargetContext(), RealEstateManagerDatabase::class.java)
